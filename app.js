...
app.get(routes.logger, function(req, res) {
  ...
  if (fs.existsSync(_file)) res.sendFile(_file);
  else res.end("No errors logged yet");
});
...
app.listen(app.get("port"), app.get("host"), function() {
  ...
  console.log(
    "Crontab UI is running at http://" + app.get("host") + ":" + app.get("port")
  );
});
